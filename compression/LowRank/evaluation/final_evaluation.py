...
if __name__ == "__main__":
    ...
    # ------------------------------------- FOUNDATION FNO ---------------------------------------
        ratio = hyperparameters["Foundation FNO"][i]
        ...
        results_by_model["Foundation FNO"][ratio] = ffnocompare

    # ------------------------------------- FOUNDATION CODANO ---------------------------------------
        ratio = hyperparameters["Foundation Codano"][i]
        ...
        results_by_model["Foundation Codano"][ratio] = fcodano_compare

    # ------------------------------------- CODANO ---------------------------------------
        ratio = hyperparameters["Codano"][i]
    ...
    # ------------------------------------- FNO 128 ---------------------------------------
        ratio = hyperparameters["FNO 128x128"][i]
        ...
        fnocompare_128 = compare_models(
            model1=fno_model_128,
            model2=fnolowrank_model_128,
            test_loaders=validation_loaders_fno128,
            data_processor=data_processor_fno128,
            device=device,
            track_performance=True
        )
        results_by_model["FNO 128x128"][ratio] = fnocompare_128

    # ------------------------------------- Results Store ---------------------------------------
    with open("compression/LowRank/results/result.pkl", "wb") as f:
