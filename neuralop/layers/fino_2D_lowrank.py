...
from neuralop.layers.foundation_codano_spectral_convolution_lowrank import SpectralConv_lowrank


class SpectralConvKernel2d_lowrank(SpectralConv_lowrank):
    """
    Parameters
    ---
