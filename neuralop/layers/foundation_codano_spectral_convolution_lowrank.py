...
class SpectralConv_lowrank(BaseSpectralConv):
...
class SpectralConv1d(SpectralConv_lowrank):
    """1D Spectral Conv
...
# class SpectralConv2d(SpectralConv_lowrank):
...
# class SpectralConv3d(SpectralConv_lowrank):
